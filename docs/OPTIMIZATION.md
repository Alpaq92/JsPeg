...
| **SOF1** | Extended sequential DCT (Huffman) | ✅ | ✅ **12-bit** (8-bit encodes as SOF0) | decode 8/12-bit; `encode({ precision: 12 })` emits a **12-bit SOF1** (grayscale), cross-checked vs libjpeg-turbo |
