...
| **SOF1** | Extended sequential DCT (Huffman) | ✅ | ✅ **8/12-bit** | decode + `encode({ precision: 12 })` both cover **8/12-bit DCT** (12-bit encode is grayscale), cross-checked vs libjpeg-turbo |
